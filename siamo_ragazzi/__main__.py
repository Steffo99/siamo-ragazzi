...
@click.option("-t", "--top-text", help="Path to the file containing text appearing at the top of the meme.", default=sys.stdin, type=click.File())
...
@click.option("-o", "--output", help="Path to save the png output to.", default=sys.stdout, type=click.File(mode="w"))
